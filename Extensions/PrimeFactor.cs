...
{
    /// <summary>
    /// Structure for calculating prime factors.  Each object of type PrimeFactor has a prime property
    /// and a multiple property.
    /// </summary>
    public struct PrimeFactor
    {
        public static readonly PrimeFactor Init = new PrimeFactor { Prime = 1, Multiplicity = 1 };
